        ...
        <div class="row align-items-center">
          <div class="col-md-12">
            ...
            <ul class="breadcrumb">
              ...
              <li class="breadcrumb-item" aria-current="page"><a href="{{ route('boms.index') }}">BOM</a></li>
        ...
        <form 
            ...
            @foreach ($record->getFillable() as $field)
                <div class="form-group row">
                    ...
                    @if ($field === 'item_id' || $field === 'component_id')
                        <select name="{{ $field }}" id="{{ $field }}" class="form-control">
                            <option value="">-- Pilih Item --</option>
                            @foreach ($items as $item)
                                <option value="{{ $item->item_id }}" {{ old($field, $record->$field) == $item->item_id ? 'selected' : '' }}>
